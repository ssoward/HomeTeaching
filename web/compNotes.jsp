...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <form method="post" action="NewNote">
	<tr align=center>
  <td>Keeping track of comps: <%=compPid%><br>  <font size=2>Double click to clear screen.</font>
  </td>
  </tr>
	<tr align=center>
	...
	<tr>
        ...
        if(tNote.length()>10){
          ...
          <%}%>
				...
				<td>&nbsp;<a href="./compNotes.jsp?compPid=<%=compPid%>&notePid=<%=temp.getPid()%>">view</a></td>
				<td>&nbsp;<a href="./compNotes.jsp?compPid=<%=compPid%>&delNote=<%=temp.getPid()%>">remove</a></td>
			</tr>
			<%
			count++;           
            flip = !flip;
