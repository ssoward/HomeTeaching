...
<table width="754" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table border=0>
			<tr>
				<form name="editMemberForm" method="post" action="NewMember">
    	...
    	<tr>
			...
			<tr>
				...
				<%for(Family tfam: famList){ %>
					<option value="<%=tfam.getPid() %>"><%=tfam.getName()+", "+tfam.getFirstName() %></option>
					<%} %>
					</select>
					</td>
			</tr>
			...
			<form name="cancel" method="post" action="./newMember.jsp">
